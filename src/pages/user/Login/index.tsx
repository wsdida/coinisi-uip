...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    ...
    try {
      // 登录
      const msg = await login({ ...values, grant_type });
            // @ts-ignore
  ...
  const { access_token, token_type: loginType } = userLoginState;
    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.main}>
          ...
          >
            <Tabs activeKey={grant_type} onChange={setGrantType}>
              <Tabs.TabPane
                key="password"
            ...
            {access_token !== null && loginType === 'bearer' && (
              <LoginMessage
            ...
            {access_token !== null && loginType === 'mobile' && <LoginMessage content="验证码错误" />}
            {grant_type === 'mobile' && (
              <>
                <ProFormText
                  fieldProps={{
